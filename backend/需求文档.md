...
![任务管理-列表与筛选](../docs/images/task-management.png)
...
![任务定义管理-新建任务定义](../docs/images/task-definition-create.png)
...
![客户端管理-列表](../docs/images/client-management.png)
...
![数据源管理-编辑与连通性测试](../docs/images/data-source-edit.png)
...
![数据列定义管理-列表](../docs/images/column-definition-list.png)
...
![Excel导入-导入成功结果](../docs/images/excel-import-success.png)
...
![Excel导出-数据填写](../docs/images/excel-export.png)
...
- 首页总览：`dashboard-overview.png`
- 任务管理：`task-management.png`
- 任务定义管理：`task-definition-create.png`
- 客户端管理：`client-management.png`
- 数据源管理：`data-source-edit.png`
- 列定义管理：`column-definition-list.png`
- Excel 导入（空态）：`excel-import-empty.png`
- Excel 导入（成功）：`excel-import-success.png`
- Excel 导出：`excel-export.png`

> 注：上述图片文件建议统一存放于 `docs/images/` 目录并与本文件中的相对路径保持一致。
